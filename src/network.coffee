...
cert = fs.readFileSync "./miscs/RapidSSL.pem", "utf-8"

agentOptions = {}
agentOptions.ca = require("ssl-root-cas").rootCas
...
auth = (username, password, card, cb) ->
  ...
  req.post {url: hostname + path, form, agentOptions}, (err, res, body) ->
    ...
    jsdom.env body, src: [jquery], (err, res) ->
      ...
      if res.$(".block").size() != 0
        ...
        req.post {url: hostname + href, form, agentOptions}, (err, res, body) ->
          ...
          jsdom.env body, src: [jquery], (err, res) ->
            ...
            jsdom.env body, src: [jquery], (err, res) ->
              ...
              req.get {url: hostname + href, agentOptions}, (err, res, body) ->
